...
public class HealthEducationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        items.add(new HealthEducationModel("Pertolongan Pertama ketika X", "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident", "content", "Dr. Raeya", "from api"));
        items.add(new HealthEducationModel("Pertolongan Pertama ketika X", "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident", "content", "Dr. Raeya", "from api"));
        items.add(new HealthEducationModel("Pertolongan Pertama ketika X", "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident", "content", "Dr. Raeya", "from api"));
        items.add(new HealthEducationModel("Pertolongan Pertama ketika X", "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident", "content", "Dr. Raeya", "from api"));
        items.add(new HealthEducationModel("Pertolongan Pertama ketika X", "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident", "content", "Dr. Raeya", "from api"));
